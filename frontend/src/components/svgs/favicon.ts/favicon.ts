export function Favicon(height: number = 32, width: number = 32) {
  return `
      <svg height="${height}px" width="${width}px" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg"
